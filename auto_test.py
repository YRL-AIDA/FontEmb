...
from create_contr_dataset import create_dataset, CommonGenerator
...
if __name__ == "__main__":
    ...
    create_dataset(dataset_train_base, CommonGenerator())
    create_dataset(dataset_test_base, CommonGenerator())
    ...
    datasets = {"dataset_base": dataset_base}
    ...
    for params in exps:
        train_model(params)
        tests(params, {"test_base": test_base})
